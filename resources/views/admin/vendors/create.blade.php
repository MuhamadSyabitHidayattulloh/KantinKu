...
<div class="flex h-screen bg-gray-50">
    ...
    <main class="flex-1 overflow-auto flex flex-col">
        <x-layout.page-header title="Tambah Vendor">
            <a href="/admin/vendors" class="text-gray-600 hover:text-gray-900">← Kembali</a>
        ...
        <div class="flex-1 p-8 overflow-auto">
            <x-cards.card>
                <div class="max-w-2xl">
                    <form action="/admin/vendors" method="POST" class="space-y-6">
                        @csrf
                        
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 mb-2">Nama Vendor</label>
                        ...
                        <div class="flex gap-3 pt-4">
                            ...
                            <a href="/admin/vendors" class="px-6 py-2 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50">
                                Batal
                            </a>
                        </div>
                    </form>
