...
<div class="flex h-screen bg-gray-50">
    ...
    <main class="flex-1 overflow-auto flex flex-col">
        <x-layout.page-header title="Tambah User">
                ...
                <div class="max-w-2xl">
                    <form action="/admin/users" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:outline-none focus:border-primary-600 focus:ring-2 focus:ring-primary-200 @error('email') border-red-500 @enderror">
