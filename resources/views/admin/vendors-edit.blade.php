...
<div class="flex h-screen bg-gray-50">
    ...
    <main class="flex-1 overflow-auto flex flex-col">
        <x-layout.page-header title="Edit Vendor">
            <a href="/admin/vendors" class="text-primary-700 text-sm font-medium hover:underline">
        ...
        <div class="flex-1 p-8 overflow-auto">
            <x-cards.card style="max-width: 600px; margin: 0 auto;">
                <h3 class="font-poppins text-lg font-bold text-gray-800 mb-6">Form Edit Vendor</h3>
                ...
                <form action="{{ route('admin.vendors.update', $vendor) }}" method="POST" class="space-y-5">
                    @csrf
                    @method('PUT')

                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">Nama Vendor/Warung</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">Konfirmasi Password Baru</label>
                    ...
                    <div class="flex gap-3 pt-4">
                        ...
                        <a href="/admin/vendors" class="flex-1 px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition text-center">
                            ✕ Batal
                        </a>
                    </div>
                </form>
